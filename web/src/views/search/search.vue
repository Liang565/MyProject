<template>
  <div>
    <div class="flex justify-evenly">
      ...
      <div class="translate-y-1/4 ml-2">
        <!-- 返回首页 -->
        <button @click="goHome">
          <icon-park
            type="home"
      ...
      <div class="w-5/6">
        ...
        >
          <template #right-icon>
            <div class="border-2 border-red-400 rounded-lg bg-red-200 text-sm">
              搜索
            </div>
          </template>
        </van-search>
    ...
    <!-- 田字展示 -->
    <div v-show="!upright">
      <van-grid :border="false" :column-num="2" :centered="true">
        <van-grid-item v-for="i in data" @click="goGoods(i)">
          <div class="w-full h-full bg-gray-200">
            ...
            <div class="flex justify-center text-lg text-red-600">
              ￥{{ i.price }}
            </div>
          </div>
        </van-grid-item>
